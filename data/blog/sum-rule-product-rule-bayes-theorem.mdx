---
title: 'Probability Theory, Maximum Likelihood Estimate'
date: '2022-05-01'
lastmod: '2022-05-01'
tags:
  [
...
draft: false
layout: PostSimple
summary: 'Discuss the Joint Probability, Marginal Probability, Conditional Probability and Maximum Likelihood Estimate with Math equations and Python code example.'
images: []
authors: ['default']
---
...
- $P(Y=y_j|X=x_i)$ describes the probability of finding our target $(Y=y_j)$ given the evidence $(X=x_i)$.
