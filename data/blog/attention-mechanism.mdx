...
class AbstractAttention(torch.nn.Module):
  ...
  def compute_compatibility_score(
    ...
    Args:
      ...
      attention_mask: typing.Optional[torch.Tensor]: The mask for post-process
  ...
  def forward(
    ...
    # 2. There can be negative value in the scores matrix, therefore 0 is not
...
# (torch.Size([100, 20, 10]), torch.Size([100, 20, 20]))
out.size(), attention_weights.size()
```
